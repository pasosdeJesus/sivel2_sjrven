...
CREATE SEQUENCE public.aspsicosocial_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.aspsicosocial (
    id integer DEFAULT nextval('public.aspsicosocial_id_seq'::regclass) NOT NULL,
...
CREATE VIEW public.cben2 AS
 SELECT cben1.id_caso,
   ...
   FROM (((((public.cben1
     LEFT JOIN public.sivel2_sjr_desplazamiento ON ((cben1.id_caso = sivel2_sjr_desplazamiento.id_caso)))
     LEFT JOIN public.sip_ubicacion ubicacion ON ((sivel2_sjr_desplazamiento.id_expulsion = ubicacion.id)))
...
CREATE TABLE public.cor1440_gen_actividad (
    ...
    descripcion character varying(5000),
    metodologia character varying(5000)
);
...
CREATE SEQUENCE public.emprendimiento_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.emprendimiento (
    id integer DEFAULT nextval('public.emprendimiento_id_seq'::regclass) NOT NULL,
    nombre character varying(100) NOT NULL,
    fechacreacion date DEFAULT ('now'::text)::date NOT NULL,
    fechadeshabilitacion date,
    created_at timestamp without time zone,
...
--
-- Name: sivel2_sjr_motivosjr_derecho fk_rails_00fcb50e1e; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_motivosjr_derecho
    ADD CONSTRAINT fk_rails_00fcb50e1e FOREIGN KEY (derecho_id) REFERENCES public.sivel2_sjr_derecho(id);
...
--
-- Name: sivel2_sjr_progestado_derecho fk_rails_115bca8b2c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_progestado_derecho
    ADD CONSTRAINT fk_rails_115bca8b2c FOREIGN KEY (derecho_id) REFERENCES public.sivel2_sjr_derecho(id);


--
-- Name: sivel2_sjr_ayudasjr_derecho fk_rails_1e1b715428; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_ayudasjr_derecho
    ADD CONSTRAINT fk_rails_1e1b715428 FOREIGN KEY (ayudasjr_id) REFERENCES public.sivel2_sjr_ayudasjr(id);
...
--
-- Name: sivel2_sjr_ayudasjr_derecho fk_rails_5ff8e2bab4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_ayudasjr_derecho
    ADD CONSTRAINT fk_rails_5ff8e2bab4 FOREIGN KEY (derecho_id) REFERENCES public.sivel2_sjr_derecho(id);
...
--
-- Name: sivel2_sjr_ayudaestado_derecho fk_rails_69992070a3; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_ayudaestado_derecho
    ADD CONSTRAINT fk_rails_69992070a3 FOREIGN KEY (ayudaestado_id) REFERENCES public.sivel2_sjr_ayudaestado(id);
...
--
-- Name: sivel2_sjr_ayudaestado_derecho fk_rails_b0849b6ac6; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_ayudaestado_derecho
    ADD CONSTRAINT fk_rails_b0849b6ac6 FOREIGN KEY (derecho_id) REFERENCES public.sivel2_sjr_derecho(id);
...
--
-- Name: sivel2_sjr_motivosjr_derecho fk_rails_b909b1844d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_motivosjr_derecho
    ADD CONSTRAINT fk_rails_b909b1844d FOREIGN KEY (motivosjr_id) REFERENCES public.sivel2_sjr_motivosjr(id);
...
--
-- Name: sivel2_sjr_progestado_derecho fk_rails_f808034a20; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_sjr_progestado_derecho
    ADD CONSTRAINT fk_rails_f808034a20 FOREIGN KEY (progestado_id) REFERENCES public.sivel2_sjr_progestado(id);
